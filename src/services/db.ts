...
export function subscribeToCustomers(callback: () => void, pollMs = 10000) {
  const POLL_MS = Math.max(5000, Number(pollMs) || 10000);
...
export function subscribeToCallLogs(callback: () => void, pollMs = 12000) {
  const POLL_MS = Math.max(5000, Number(pollMs) || 12000);
